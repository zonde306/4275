...
void CFuncRotating::SpinUp(void)
{
	...
	if (abs((int)vecAVel.x) >= fabs((int)pev->movedir.x * pev->speed) && abs((int)vecAVel.y) >= fabs((int)pev->movedir.y * pev->speed) && abs((int)vecAVel.z) >= fabs((int)pev->movedir.z * pev->speed))
	{
